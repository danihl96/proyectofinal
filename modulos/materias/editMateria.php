<?php 
// Modificado por John Alexander Bejarano Tobar
    ...
    $mat_id = $mat_nombre = $mat_intensidad_horaria = $mat_tipo = $mat_creditos = "";
    foreach($result->fetchAll(PDO::FETCH_OBJ) as $r){
        $mat_id = $r->id;
        $mat_nombre = $r->nombre;
        $mat_intensidad_horaria = $r->intensidad_horaria;
        $mat_tipo = $r->tipo;
                    ...
                    <div class="card-body">
                        <form action="update.php" method="POST" name="forrol">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="intensidad_horaria" name="intensidad_horaria" value="<?= $mat_intensidad_horaria ?>" required>
                            </div>

                            <div class="form-group">
                                <label for="tipo">Tipo</label>
                                <input type="text" class="form-control" id="tipo" name="tipo" value="<?= $mat_tipo ?>" required>
                            </div>
